				...
				<div class="col-md-12 col-lg-6 col-sm-12 smt-30 xmt-30">
					<div class="htc__product__details__inner">
						...
						<hr>
							...
							<p>Kindly fill the form & we will deliver in a few days</p>
						</div>
						<div class="pro__details">
							<form method="POST" action="process.php/thankyou.html" id="orderfrm">
...
$("#orderfrm").validate({rules:{
  ...
  messages: {
	mobile: "Please give your valid mobile number '772454244' without the '0' in front",
  },
